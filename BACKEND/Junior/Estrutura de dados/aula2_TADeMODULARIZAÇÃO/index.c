#include <stdlib.h> 
#include <math.h> //Calculo com raiz
#include "index.h" //Biblioteca
...
{
    //Ponteiro apelido p = (Ponteiro) alocando um espaço na memória
...
//Calcula a distância entre dois ponteiros
